...
(self["webpackChunkfls_start"] = self["webpackChunkfls_start"] || []).push([ [ 669 ], {
    669: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            ...
            return function(Module) {
                ...
                function extendError(baseErrorType, errorName) {
                    ...
                    errorClass.prototype.toString = function() {
                        if (this.message === void 0) return this.name; else return this.name + ": " + this.message;
                    };
                    return errorClass;
                }
                ...
                function count_emval_handles() {
                    var count = 0;
                    for (var i = 5; i < emval_handle_array.length; ++i) if (emval_handle_array[i] !== void 0) ++count;
                    return count;
                }
                function get_first_emval() {
                    for (var i = 5; i < emval_handle_array.length; ++i) if (emval_handle_array[i] !== void 0) return emval_handle_array[i];
                    return null;
                }
                function init_emval() {
                ...
                function craftInvokerFunction(humanName, argTypes, classType, cppInvokerFunc, cppTargetFunc) {
                    ...
                    if (needsDestructorStack) invokerFnBody += "runDestructors(destructors);\n"; else for (i = isClassMethodFunc ? 1 : 2; i < argTypes.length; ++i) {
                ...
                function replacePublicSymbol(name, value, numArguments) {
                    ...
                    if (void 0 !== Module[name].overloadTable && void 0 !== numArguments) Module[name].overloadTable[numArguments] = value; else {
                        Module[name] = value;
                ...
                function __embind_register_std_string(rawType, name) {
                    ...
                    registerType(rawType, {
                            ...
                            if (stdStringIsUTF8) {
                                ...
                                for (var i = 0; i <= length; ++i) {
                                    ...
                                    if (i == length || HEAPU8[currentBytePtr] == 0) {
                                        ...
                                        if (str === void 0) str = stringSegment; else {
                                ...
                                for (i = 0; i < length; ++i) a[i] = String.fromCharCode(HEAPU8[value + 4 + i]);
                                str = a.join("");
                            }
                            _free(value);
                            return str;
                        ...
                        toWireType: function(destructors, value) {
                            ...
                            if (stdStringIsUTF8 && valueIsOfTypeString) stringToUTF8(value, ptr + 4, length + 1); else if (valueIsOfTypeString) for (var i = 0; i < length; ++i) {
                            ...
                            } else for (i = 0; i < length; ++i) HEAPU8[ptr + 4 + i] = value[i];
                ...
                var MEMFS = {
                    ...
                    stream_ops: {
                        ...
                        write: function(stream, buffer, offset, length, position, canOwn) {
                            ...
                            node.timestamp = Date.now();
                            if (buffer.subarray && (!node.contents || node.contents.subarray)) if (canOwn) {
                ...
                var FS = {
                    ...
                    writeFile: function(path, data, opts) {
                        ...
                        } else if (ArrayBuffer.isView(data)) FS.write(stream, data, 0, data.byteLength, void 0, opts.canOwn); else throw new Error("Unsupported data type");
                        FS.close(stream);
                    },
                    cwd: function() {
                    ...
                    forceLoadFile: function(obj) {
                        ...
                        if (typeof XMLHttpRequest !== "undefined") throw new Error("Lazy loading should have been performed (contents set) in createLazyFile, but it was not. Lazy loading only works in web workers. Use --embed-file or --preload-file in emcc on the main thread."); else if (read_) try {
                    ...
                    createLazyFile: function(parent, name, url, canRead, canWrite) {
                        ...
                        LazyUint8Array.prototype.cacheLength = function LazyUint8Array_cacheLength() {
                            ...
                            var doXHR = function(from, to) {
                                ...
                                xhr.send(null);
                                if (!(xhr.status >= 200 && xhr.status < 300 || xhr.status === 304)) throw new Error("Couldn't load " + url + ". Status: " + xhr.status);
                                if (xhr.response !== void 0) return new Uint8Array(xhr.response || []); else return intArrayFromString(xhr.responseText || "", true);
                            };
                            var lazyArray = this;
                        ...
                        stream_ops.read = function stream_ops_read(stream, buffer, offset, length, position) {
                            ...
                            if (contents.slice) for (var i = 0; i < size; i++) buffer[offset + i] = contents[position + i]; else for (i = 0; i < size; i++) buffer[offset + i] = contents.get(position + i);
                            return size;
                        };
                ...
                Module["___embind_register_native_and_builtin_types"] = function() {
                    return (Module["___embind_register_native_and_builtin_types"] = Module["asm"]["G"]).apply(null, arguments);
                };
                ...
                Module["dynCall_iiiiij"] = function() {
                    return (Module["dynCall_iiiiij"] = Module["asm"]["N"]).apply(null, arguments);
                };
                Module["dynCall_iiiiijj"] = function() {
                    return (Module["dynCall_iiiiijj"] = Module["asm"]["O"]).apply(null, arguments);
                };
                Module["dynCall_iiiiiijj"] = function() {
                    return (Module["dynCall_iiiiiijj"] = Module["asm"]["P"]).apply(null, arguments);
                };
                Module["dynCall_viijii"] = function() {
                    return (Module["dynCall_viijii"] = Module["asm"]["Q"]).apply(null, arguments);
                };
                Module["ccall"] = ccall;
                var calledRun;
