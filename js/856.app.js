...
(self["webpackChunkfls_start"] = self["webpackChunkfls_start"] || []).push([ [ 856 ], {
    856: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        function da(e, r) {
            this.source = e, this.sourceIndex = 0, this.tag = 0, this.bitcount = 0, this.dest = r, 
            this.destLen = 0, this.ltree = new Le, this.dtree = new Le;
        }
        ...
        function Mr(e, r, t) {
            for (;;) {
                ...
                if (a < 256) e.dest[e.destLen++] = a; else {
                    var n, s, i, u;
                    for (a -= 257, n = ie(e, Tr[a], kr[a]), s = hr(e, t), i = e.destLen - ie(e, Tt[s], kt[s]), 
                    u = i; u < i + n; ++u) e.dest[e.destLen++] = e.dest[u];
                }
            }
        }
        function ba(e) {
            for (var r, t, a; e.bitcount > 8; ) e.sourceIndex--, e.bitcount -= 8;
            if (r = e.source[e.sourceIndex + 1], r = 256 * r + e.source[e.sourceIndex], t = e.source[e.sourceIndex + 3], 
            t = 256 * t + e.source[e.sourceIndex + 2], r !== (~t & 65535)) return xt;
            for (e.sourceIndex += 4, a = r; a; --a) e.dest[e.destLen++] = e.source[e.sourceIndex++];
            return e.bitcount = 0, Sr;
        }
        function Sa(e, r) {
            var a, n, s, t = new da(e, r);
            do {
        ...
        pe.prototype.addPoint = function(e, r) {
            typeof e == "number" && ((isNaN(this.x1) || isNaN(this.x2)) && (this.x1 = e, this.x2 = e), 
            e < this.x1 && (this.x1 = e), e > this.x2 && (this.x2 = e)), typeof r == "number" && ((isNaN(this.y1) || isNaN(this.y2)) && (this.y1 = r, 
            this.y2 = r), r < this.y1 && (this.y1 = r), r > this.y2 && (this.y2 = r));
        };
        ...
        P.prototype.extend = function(e) {
            if (e.commands) e = e.commands; else if (e instanceof pe) {
                var r = e;
                this.moveTo(r.x1, r.y1), this.lineTo(r.x2, r.y1), this.lineTo(r.x2, r.y2), this.lineTo(r.x1, r.y2), 
                this.close();
                return;
            }
        ...
        P.prototype.toSVG = function(e) {
            var r = '<path d="';
            return r += this.toPathData(e), r += '"', this.fill && this.fill !== "black" && (this.fill === null ? r += ' fill="none"' : r += ' fill="' + this.fill + '"'), 
            this.stroke && (r += ' stroke="' + this.stroke + '" stroke-width="' + this.strokeWidth + '"'), 
            r += "/>", r;
        };
        ...
        g.NUMBER = function(e) {
            ...
            [ (e >> 8) + 247, e & 255 ]) : e >= -1131 && e <= -108 ? (e = -e - 108, [ (e >> 8) + 251, e & 255 ]) : e >= -32768 && e <= 32767 ? g.NUMBER16(e) : g.NUMBER32(e);
        };
        E.NUMBER = function(e) {
        ...
        var ze, He = typeof WeakMap == "function" && new WeakMap, ka = function(e) {
            if (!ze) {
                ze = {};
        ...
        g.OPERAND = function(e, r) {
            var t = [];
            if (Array.isArray(r)) for (var a = 0; a < r.length; a += 1) U.argument(e.length === r.length, "Not enough arguments given for type" + r), 
            t = t.concat(g.OPERAND(e[a], r[a])); else if (r === "SID") t = t.concat(g.NUMBER(e)); else if (r === "offset") t = t.concat(g.NUMBER32(e)); else if (r === "number") t = t.concat(g.NUMBER(e)); else if (r === "real") t = t.concat(g.REAL(e)); else throw new Error("Unknown operand type " + r);
            return t;
        };
        g.OP = g.BYTE;
        E.OP = E.BYTE;
        ...
        g.TABLE = function(e) {
            ...
            for (var f = 0; f < a.length; f += 1) {
                ...
                U.argument(p < 65536, "Table " + e.tableName + " too big."), r[h] = p >> 8, r[h + 1] = p & 255, 
                r = r.concat(a[f]);
            }
            return r;
        };
        ...
        function Ke(e, r) {
            z.call(this, "lookupListTable", dr("lookup", e, (function(t) {
                ...
                return U.assert(!!a, "Unable to write GSUB lookup type " + t.lookupType + " tables."), 
                new z("lookupTable", [ {
                    name: "lookupType",
                    type: "USHORT",
                    value: t.lookupType
        ...
        v.prototype.parseULongList = function(e) {
            ...
            for (var r = new Array(e), t = this.data, a = this.offset + this.relativeOffset, n = 0; n < e; n++) r[n] = t.getUint32(a), 
            a += 4;
        ...
        v.prototype.parseOffset16List = v.prototype.parseUShortList = function(e) {
            ...
            for (var r = new Array(e), t = this.data, a = this.offset + this.relativeOffset, n = 0; n < e; n++) r[n] = t.getUint16(a), 
            a += 2;
            return this.relativeOffset += e * 2, r;
        };
        v.prototype.parseShortList = function(e) {
            for (var r = new Array(e), t = this.data, a = this.offset + this.relativeOffset, n = 0; n < e; n++) r[n] = t.getInt16(a), 
            a += 2;
            return this.relativeOffset += e * 2, r;
        };
        ...
        v.prototype.parseValueRecord = function(e) {
            if (e === void 0 && (e = this.parseUShort()), e !== 0) {
                var r = {};
                return e & 1 && (r.xPlacement = this.parseShort()), e & 2 && (r.yPlacement = this.parseShort()), 
                e & 4 && (r.xAdvance = this.parseShort()), e & 8 && (r.yAdvance = this.parseShort()), 
                e & 16 && (r.xPlaDevice = void 0, this.parseShort()), e & 32 && (r.yPlaDevice = void 0, 
                this.parseShort()), e & 64 && (r.xAdvDevice = void 0, this.parseShort()), e & 128 && (r.yAdvDevice = void 0, 
                this.parseShort()), r;
            }
        };
        ...
        v.prototype.parseListOfLists = function(e) {
            for (var r = this.parseOffset16List(), t = r.length, a = this.relativeOffset, n = new Array(t), s = 0; s < t; s++) {
                ...
                if (this.relativeOffset = i, e) {
                    for (var u = this.parseOffset16List(), o = new Array(u.length), l = 0; l < u.length; l++) this.relativeOffset = i + u[l], 
                    o[l] = e.call(this);
                    n[s] = o;
        ...
        function Aa(e, r) {
            ...
            for (var a = 0; a < t; a += 1) for (var n = r.parseULong(), s = r.parseULong(), i = r.parseULong(), u = n; u <= s; u += 1) e.glyphIndexMap[u] = i, 
            i++;
        }
        function Ba(e, r, t, a, n) {
            ...
            for (var i = new k.Parser(t, a + n + 14), u = new k.Parser(t, a + n + 16 + s * 2), o = new k.Parser(t, a + n + 16 + s * 4), l = new k.Parser(t, a + n + 16 + s * 6), f = a + n + 16 + s * 8, h = 0; h < s - 1; h += 1) for (var p = void 0, c = i.parseUShort(), d = u.parseUShort(), x = o.parseShort(), m = l.parseUShort(), y = d; y <= c; y += 1) m !== 0 ? (f = l.offset + l.relativeOffset - 2, 
            f += m, f += (y - d) * 2, p = k.getUShort(t, f), p !== 0 && (p = p + x & 65535)) : p = y + x & 65535, 
            e.glyphIndexMap[y] = p;
        }
        function Ia(e, r) {
            var t = {};
            t.version = k.getUShort(e, r), U.argument(t.version === 0, "cmap table version should be 0."), 
        ...
        function Ga(e) {
            ...
            if (s.segCountX2 = (o - l) * 2, s.searchRange = Math.pow(2, Math.floor(Math.log(o - l) / Math.log(2))) * 2, 
            s.entrySelector = Math.log(s.searchRange / 2) / Math.log(2), s.rangeShift = s.segCountX2 - s.searchRange, 
            s.fields = s.fields.concat(f), s.fields.push({
                name: "reservedPad",
                type: "USHORT",
                value: 0
            }), s.fields = s.fields.concat(h), s.fields = s.fields.concat(p), s.fields = s.fields.concat(c), 
            s.fields = s.fields.concat(d), s.cmap4Length = 14 + f.length * 2 + 2 + h.length * 2 + p.length * 2 + c.length * 2 + d.length * 2, 
            !r) {
                var y = 16 + x.length * 4;
        ...
        Ot.prototype.charToGlyphIndex = function(e) {
            ...
            if (t) for (var a = 0; a < t.length; a += 1) for (var n = t.get(a), s = 0; s < n.unicodes.length; s += 1) if (n.unicodes[s] === r) return a;
            return null;
        };
        function Lt(e) {
            this.cmap = e;
        ...
        Q.prototype.bindConstructorValues = function(e) {
            ...
            this.unicodes = e.unicodes || e.unicode !== void 0 ? [ e.unicode ] : [], "xMin" in e && (this.xMin = e.xMin), 
            "yMin" in e && (this.yMin = e.yMin), "xMax" in e && (this.xMax = e.xMax), "yMax" in e && (this.yMax = e.yMax), 
            "advanceWidth" in e && (this.advanceWidth = e.advanceWidth), Object.defineProperty(this, "path", qa(this, e.path));
        };
        ...
        Q.prototype.getPath = function(e, r, t, a, n) {
            ...
            if (a.hinting && n && n.hinting && (i = this.path && n.hinting.exec(this, t)), i) s = n.hinting.getCommands(i), 
            e = Math.round(e), r = Math.round(r), u = o = 1; else {
        ...
        Q.prototype.getContours = function() {
            ...
            return U.argument(r.length === 0, "There are still points left in the current contour."), 
            e;
        };
        Q.prototype.getMetrics = function() {
            for (var e = this.path.commands, r = [], t = [], a = 0; a < e.length; a += 1) {
                var n = e[a];
                n.type !== "Z" && (r.push(n.x), t.push(n.y)), (n.type === "Q" || n.type === "C") && (r.push(n.x1), 
                t.push(n.y1)), n.type === "C" && (r.push(n.x2), t.push(n.y2));
            }
            var s = {
            ...
            return isFinite(s.xMin) || (s.xMin = 0), isFinite(s.xMax) || (s.xMax = this.advanceWidth), 
            isFinite(s.yMin) || (s.yMin = 0), isFinite(s.yMax) || (s.yMax = 0), s.rightSideBearing = this.advanceWidth - s.leftSideBearing - (s.xMax - s.xMin), 
            s;
        };
        ...
        Q.prototype.drawPoints = function(e, r, t, a) {
            function n(h, p, c, d) {
                e.beginPath();
                for (var x = 0; x < h.length; x += 1) e.moveTo(p + h[x].x * d, c + h[x].y * d), 
        ...
        Q.prototype.drawMetrics = function(e, r, t, a) {
            var n;
            r = r !== void 0 ? r : 0, t = t !== void 0 ? t : 0, a = a !== void 0 ? a : 24, n = 1 / this.path.unitsPerEm * a, 
            e.lineWidth = 1, e.strokeStyle = "black", ye.line(e, r, -1e4, r, 1e4), ye.line(e, -1e4, t, 1e4, t);
            var s = this.xMin || 0, i = this.yMin || 0, u = this.xMax || 0, o = this.yMax || 0, l = this.advanceWidth || 0;
            e.strokeStyle = "blue", ye.line(e, r + s * n, -1e4, r + s * n, 1e4), ye.line(e, r + u * n, -1e4, r + u * n, 1e4), 
            ye.line(e, -1e4, t + -i * n, 1e4, t + -i * n), ye.line(e, -1e4, t + -o * n, 1e4, t + -o * n), 
            e.strokeStyle = "green", ye.line(e, r + l * n, -1e4, r + l * n, 1e4);
        };
        function _e(e, r, t) {
        ...
        Cr.prototype.get = function(e) {
            if (this.glyphs[e] === void 0) {
                ...
                this.font.cffEncoding ? this.font.isCIDFont ? r.name = "gid" + e : r.name = this.font.cffEncoding.charset[e] : this.font.glyphNames.names && (r.name = this.font.glyphNames.glyphIndexToName(e)), 
        ...
        function Ya(e, r, t, a, n, s) {
            return function() {
                ...
                }, _e(i, "xMin", "_xMin"), _e(i, "xMax", "_xMax"), _e(i, "yMin", "_yMin"), _e(i, "yMax", "_yMax"), 
                i;
            };
        }
        function Za(e, r, t, a) {
        ...
        function ja(e, r) {
            ...
            if (r === 29) return t = e.parseByte(), a = e.parseByte(), n = e.parseByte(), s = e.parseByte(), 
            t << 24 | a << 16 | n << 8 | s;
            if (r === 30) return Ja(e);
        ...
        function Dt(e, r, t) {
            for (var n, a = {}, s = 0; s < r.length; s += 1) {
                var i = r[s];
                if (Array.isArray(i.type)) {
                    var u = [];
                    u.length = i.type.length;
                    for (var o = 0; o < i.type.length; o++) n = e[i.op] !== void 0 ? e[i.op][o] : void 0, 
                    n === void 0 && (n = i.value !== void 0 && i.value[o] !== void 0 ? i.value[o] : null), 
                    i.type[o] === "SID" && (n = Oe(t, n)), u[o] = n;
                    a[i.name] = u;
                } else n = e[i.op], n === void 0 && (n = i.value !== void 0 ? i.value : null), i.type === "SID" && (n = Oe(t, n)), 
                a[i.name] = n;
            }
            return a;
        }
        function en(e, r) {
            var t = {};
            return t.formatMajor = k.getCard8(e, r), t.formatMinor = k.getCard8(e, r + 1), t.size = k.getCard8(e, r + 2), 
            t.offsetSize = k.getCard8(e, r + 3), t.startOffset = r, t.endOffset = r + 4, t;
        }
        var At = [ {
            name: "version",
            op: 0,
        ...
        function an(e, r, t) {
            ...
            if (i === 0) for (var u = s.parseCard8(), o = 0; o < u; o += 1) a = s.parseCard8(), 
            n[a] = o; else if (i === 1) {
                var l = s.parseCard8();
                a = 1;
                for (var f = 0; f < l; f += 1) for (var h = s.parseCard8(), p = s.parseCard8(), c = h; c <= h + p; c += 1) n[c] = a, 
                a += 1;
            } else throw new Error("Unknown encoding format " + i);
            return new je(n, t);
        }
        function _r(e, r, t) {
            var a, n, s, i, d, x, m, y, u = new P, o = [], l = 0, f = !1, h = !1, p = 0, c = 0;
            if (e.isCIDFont) {
            ...
            } else d = e.tables.cff.topDict._subrs, x = e.tables.cff.topDict._subrsBias, m = e.tables.cff.topDict._defaultWidthX, 
            ...
            function D() {
                var F;
                F = o.length % 2 !== 0, F && !f && (R = o.shift() + y), l += o.length >> 1, o.length = 0, 
                f = !0;
            }
            function L(F) {
                for (var G, Y, Z, j, $, M, N, W, _, V, H, X, A = 0; A < F.length; ) {
                    ...
                    switch (A += 1, q) {
                      ...
                      case 6:
                        for (;o.length > 0 && (p += o.shift(), u.lineTo(p, c), o.length !== 0); ) c += o.shift(), 
                        u.lineTo(p, c);
                        break;

                      case 7:
                        for (;o.length > 0 && (c += o.shift(), u.lineTo(p, c), o.length !== 0); ) p += o.shift(), 
                        u.lineTo(p, c);
                        break;

                      case 8:
                        for (;o.length > 0; ) a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), 
                        p = s + o.shift(), c = i + o.shift(), u.curveTo(a, n, s, i, p, c);
                        break;
                      ...
                      case 12:
                        switch (q = F[A], A += 1, q) {
                          case 35:
                            a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), 
                            W = i + o.shift(), _ = N + o.shift(), V = W + o.shift(), H = _ + o.shift(), X = V + o.shift(), 
                            p = H + o.shift(), c = X + o.shift(), o.shift(), u.curveTo(a, n, s, i, N, W), u.curveTo(_, V, H, X, p, c);
                            break;

                          case 34:
                            a = p + o.shift(), n = c, s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), 
                            W = i, _ = N + o.shift(), V = i, H = _ + o.shift(), X = c, p = H + o.shift(), u.curveTo(a, n, s, i, N, W), 
                            u.curveTo(_, V, H, X, p, c);
                            break;

                          case 36:
                            a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), 
                            W = i, _ = N + o.shift(), V = i, H = _ + o.shift(), X = V + o.shift(), p = H + o.shift(), 
                            u.curveTo(a, n, s, i, N, W), u.curveTo(_, V, H, X, p, c);
                            break;

                          case 37:
                            a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), N = s + o.shift(), 
                            W = i + o.shift(), _ = N + o.shift(), V = W + o.shift(), H = _ + o.shift(), X = V + o.shift(), 
                            Math.abs(H - p) > Math.abs(X - c) ? p = H + o.shift() : c = X + o.shift(), u.curveTo(a, n, s, i, N, W), 
                            u.curveTo(_, V, H, X, p, c);
                            break;
                      ...
                      case 24:
                        for (;o.length > 2; ) a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), 
                        p = s + o.shift(), c = i + o.shift(), u.curveTo(a, n, s, i, p, c);
                      ...
                      case 25:
                        ...
                        a = p + o.shift(), n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), p = s + o.shift(), 
                        c = i + o.shift(), u.curveTo(a, n, s, i, p, c);
                        break;

                      case 26:
                        for (o.length % 2 && (p += o.shift()); o.length > 0; ) a = p, n = c + o.shift(), 
                        s = a + o.shift(), i = n + o.shift(), p = s, c = i + o.shift(), u.curveTo(a, n, s, i, p, c);
                        break;

                      case 27:
                        for (o.length % 2 && (c += o.shift()); o.length > 0; ) a = p + o.shift(), n = c, 
                        s = a + o.shift(), i = n + o.shift(), p = s + o.shift(), c = i, u.curveTo(a, n, s, i, p, c);
                        break;
                      ...
                      case 30:
                        for (;o.length > 0 && (a = p, n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), 
                        p = s + o.shift(), c = i + (o.length === 1 ? o.shift() : 0), u.curveTo(a, n, s, i, p, c), 
                        o.length !== 0); ) a = p + o.shift(), n = c, s = a + o.shift(), i = n + o.shift(), 
                        c = i + o.shift(), p = s + (o.length === 1 ? o.shift() : 0), u.curveTo(a, n, s, i, p, c);
                        break;

                      case 31:
                        for (;o.length > 0 && (a = p + o.shift(), n = c, s = a + o.shift(), i = n + o.shift(), 
                        c = i + o.shift(), p = s + (o.length === 1 ? o.shift() : 0), u.curveTo(a, n, s, i, p, c), 
                        o.length !== 0); ) a = p, n = c + o.shift(), s = a + o.shift(), i = n + o.shift(), 
                        p = s + o.shift(), c = i + (o.length === 1 ? o.shift() : 0), u.curveTo(a, n, s, i, p, c);
                        break;

                      default:
                        q < 32 ? console.log("Glyph " + r.index + ": unknown operator " + q) : q < 247 ? o.push(q - 139) : q < 251 ? (G = F[A], 
                        A += 1, o.push((q - 247) * 256 + G + 108)) : q < 255 ? (G = F[A], A += 1, o.push(-(q - 251) * 256 - G - 108)) : (G = F[A], 
                        Y = F[A + 1], Z = F[A + 2], j = F[A + 3], A += 4, o.push((G << 24 | Y << 16 | Z << 8 | j) / 65536));
                    }
                }
            }
        ...
        function nn(e, r, t, a) {
            var s, n = [], i = new k.Parser(e, r), u = i.parseCard8();
        ...
        function sn(e, r, t, a) {
            ...
            var f = l[0];
            if (t.tables.cff.topDict = f, f._privateDict && (t.defaultWidthX = f._privateDict.defaultWidthX, 
            t.nominalWidthX = f._privateDict.nominalWidthX), f.ros[0] !== void 0 && f.ros[1] !== void 0 && (t.isCIDFont = !0), 
            t.isCIDFont) {
            ...
            var S;
            a.lowMemory ? (S = Qa(e, r + f.charStrings), t.nGlyphs = S.offsets.length) : (S = ve(e, r + f.charStrings), 
            t.nGlyphs = S.objects.length);
            var R = tn(e, r + f.charset, t.nGlyphs, u.objects);
            if (f.encoding === 0 ? t.cffEncoding = new je(Na, R) : f.encoding === 1 ? t.cffEncoding = new je(Ha, R) : t.cffEncoding = an(e, r + f.encoding, R), 
            t.encoding = t.encoding || t.cffEncoding, t.glyphs = new ue.GlyphSet(t), a.lowMemory) t._push = function(L) {
        ...
        function Mt(e, r) {
            ...
            return a >= 0 && (t = a), a = r.indexOf(e), a >= 0 ? t = a + qe.length : (t = qe.length + r.length, 
            r.push(e)), t;
        }
        function on() {
        ...
        function hn(e) {
            ...
            for (var a = 0, n = 0, s = 0; s < t.commands.length; s += 1) {
                ...
                if (o.type === "M") i = Math.round(o.x - a), u = Math.round(o.y - n), r.push({
                    ...
                    type: "OP",
                    value: 21
                }), a = Math.round(o.x), n = Math.round(o.y); else if (o.type === "L") i = Math.round(o.x - a), 
                u = Math.round(o.y - n), r.push({
                    name: "dx",
                    type: "NUMBER",
                    value: i
                }), r.push({
        ...
        function dn(e, r) {
            for (var u, t = new b.Table("CFF ", [ {
                ...
                charStrings: 999,
                private: [ 0, 999 ]
            }, s = {}, i = [], o = 1; o < e.length; o += 1) u = e.get(o), i.push(u.name);
            var l = [];
            t.header = on(), t.nameIndex = un([ r.postScriptName ]);
            var f = Vr(n, l);
            t.topDictIndex = qr(f), t.globalSubrIndex = fn(), t.charsets = pn(i, l), t.charStringsIndex = cn(e), 
            t.privateDict = vn(s, l), t.stringIndex = ln(l);
            var h = t.header.sizeOf() + t.nameIndex.sizeOf() + t.topDictIndex.sizeOf() + t.stringIndex.sizeOf() + t.globalSubrIndex.sizeOf();
            return n.charset = h, n.encoding = 0, n.charStrings = n.charset + t.charsets.sizeOf(), 
            n.private[1] = n.charStrings + t.charStringsIndex.sizeOf(), f = Vr(n, l), t.topDictIndex = qr(f), 
            t;
        }
        var Gt = {
            parse: sn,
        ...
        function gn(e, r) {
            ...
            return t.version = a.parseVersion(), t.fontRevision = Math.round(a.parseFixed() * 1e3) / 1e3, 
            t.checkSumAdjustment = a.parseULong(), t.magicNumber = a.parseULong(), U.argument(t.magicNumber === 1594834165, "Font header has wrong magic number."), 
            t.flags = a.parseUShort(), t.unitsPerEm = a.parseUShort(), t.created = a.parseLongDateTime(), 
            t.modified = a.parseLongDateTime(), t.xMin = a.parseShort(), t.yMin = a.parseShort(), 
            t.xMax = a.parseShort(), t.yMax = a.parseShort(), t.macStyle = a.parseUShort(), 
            t.lowestRecPPEM = a.parseUShort(), t.fontDirectionHint = a.parseShort(), t.indexToLocFormat = a.parseShort(), 
            t.glyphDataFormat = a.parseShort(), t;
        }
        function mn(e) {
        ...
        function yn(e, r) {
            var t = {}, a = new k.Parser(e, r);
            return t.version = a.parseVersion(), t.ascender = a.parseShort(), t.descender = a.parseShort(), 
            t.lineGap = a.parseShort(), t.advanceWidthMax = a.parseUShort(), t.minLeftSideBearing = a.parseShort(), 
            t.minRightSideBearing = a.parseShort(), t.xMaxExtent = a.parseShort(), t.caretSlopeRise = a.parseShort(), 
            t.caretSlopeRun = a.parseShort(), t.caretOffset = a.parseShort(), a.relativeOffset += 8, 
            t.metricDataFormat = a.parseShort(), t.numberOfHMetrics = a.parseUShort(), t;
        }
        function xn(e) {
        ...
        function Sn(e, r, t, a, n) {
            e._hmtxTableData = {};
            for (var s, i, u = new k.Parser(r, t), o = 0; o < n; o += 1) o < a && (s = u.parseUShort(), 
            i = u.parseShort()), e._hmtxTableData[o] = {
                advanceWidth: s,
                leftSideBearing: i
            };
        }
        ...
        function Cn(e, r) {
            var t = {}, a = new k.Parser(e, r);
            return t.version = a.parseVersion(), t.numGlyphs = a.parseUShort(), t.version === 1 && (t.maxPoints = a.parseUShort(), 
            t.maxContours = a.parseUShort(), t.maxCompositePoints = a.parseUShort(), t.maxCompositeContours = a.parseUShort(), 
            t.maxZones = a.parseUShort(), t.maxTwilightPoints = a.parseUShort(), t.maxStorage = a.parseUShort(), 
            t.maxFunctionDefs = a.parseUShort(), t.maxInstructionDefs = a.parseUShort(), t.maxStackElements = a.parseUShort(), 
            t.maxSizeOfInstructions = a.parseUShort(), t.maxComponentElements = a.parseUShort(), 
            t.maxComponentDepth = a.parseUShort()), t;
        }
        function En(e) {
        ...
        var _t = {
            parse: Cn,
            make: En
        }, Vt = [ "copyright", "fontFamily", "fontSubfamily", "uniqueID", "fullName", "version", "postScriptName", "trademark", "manufacturer", "designer", "description", "manufacturerURL", "designerURL", "license", "licenseURL", "reserved", "preferredFamily", "preferredSubfamily", "compatibleFullName", "sampleText", "postScriptFindFontName", "wwsFamily", "wwsSubfamily" ], qt = {
            0: "en",
            1: "fr",
            2: "de",
            3: "it",
        ...
        function Bn(e, r) {
            ...
            for (var o = nr(qt), l = nr(Xt), f = [], h = [], p = 0; p < a.length; p++) {
                ...
                for (var d in c) {
                    ...
                    R === void 0 && (m = 0, y = r.indexOf(d), y < 0 && (y = r.length, r.push(d)), C = 4, 
                    R = g.UTF16(x));
                    var O = Yr(R, h);
        ...
        function Mn(e, r) {
            var t = {}, a = new k.Parser(e, r);
            t.version = a.parseUShort(), t.xAvgCharWidth = a.parseShort(), t.usWeightClass = a.parseUShort(), 
            t.usWidthClass = a.parseUShort(), t.fsType = a.parseUShort(), t.ySubscriptXSize = a.parseShort(), 
            t.ySubscriptYSize = a.parseShort(), t.ySubscriptXOffset = a.parseShort(), t.ySubscriptYOffset = a.parseShort(), 
            t.ySuperscriptXSize = a.parseShort(), t.ySuperscriptYSize = a.parseShort(), t.ySuperscriptXOffset = a.parseShort(), 
            t.ySuperscriptYOffset = a.parseShort(), t.yStrikeoutSize = a.parseShort(), t.yStrikeoutPosition = a.parseShort(), 
            t.sFamilyClass = a.parseShort(), t.panose = [];
            for (var n = 0; n < 10; n++) t.panose[n] = a.parseByte();
            return t.ulUnicodeRange1 = a.parseULong(), t.ulUnicodeRange2 = a.parseULong(), t.ulUnicodeRange3 = a.parseULong(), 
            t.ulUnicodeRange4 = a.parseULong(), t.achVendID = String.fromCharCode(a.parseByte(), a.parseByte(), a.parseByte(), a.parseByte()), 
            t.fsSelection = a.parseUShort(), t.usFirstCharIndex = a.parseUShort(), t.usLastCharIndex = a.parseUShort(), 
            t.sTypoAscender = a.parseShort(), t.sTypoDescender = a.parseShort(), t.sTypoLineGap = a.parseShort(), 
            t.usWinAscent = a.parseUShort(), t.usWinDescent = a.parseUShort(), t.version >= 1 && (t.ulCodePageRange1 = a.parseULong(), 
            t.ulCodePageRange2 = a.parseULong()), t.version >= 2 && (t.sxHeight = a.parseShort(), 
            t.sCapHeight = a.parseShort(), t.usDefaultChar = a.parseUShort(), t.usBreakChar = a.parseUShort(), 
            t.usMaxContent = a.parseUShort()), t;
        }
        function Pn(e) {
        ...
        function Gn(e, r) {
            var t = {}, a = new k.Parser(e, r);
            switch (t.version = a.parseVersion(), t.italicAngle = a.parseFixed(), t.underlinePosition = a.parseShort(), 
            t.underlineThickness = a.parseShort(), t.isFixedPitch = a.parseULong(), t.minMemType42 = a.parseULong(), 
            t.maxMemType42 = a.parseULong(), t.minMemType1 = a.parseULong(), t.maxMemType1 = a.parseULong(), 
            t.version) {
              case 1:
                t.names = xe.slice();
                break;
        ...
        function jt(e) {
            ...
            for (var a = [], n = [], s = r.sizeOf() + Qr().sizeOf() * r.numTables; s % 4 !== 0; ) s += 1, 
            n.push({
                name: "padding",
                type: "BYTE",
                value: 0
            ...
            for (var i = 0; i < e.length; i += 1) {
                ...
                for (a.push({
                    ...
                    type: "RECORD",
                    value: u
                }), s += o, U.argument(!isNaN(s), "Something went wrong calculating the offset."); s % 4 !== 0; ) s += 1, 
                n.push({
                    name: "padding",
                    type: "BYTE",
                    value: 0
        ...
        function qn(e) {
            for (var o, r = [], t = [], a = [], n = [], s = [], i = [], u = [], l = 0, f = 0, h = 0, p = 0, c = 0, d = 0; d < e.glyphs.length; d += 1) {
                ...
                if (x.name !== ".notdef") {
                    var C = x.getMetrics();
                    r.push(C.xMin), t.push(C.yMin), a.push(C.xMax), n.push(C.yMax), i.push(C.leftSideBearing), 
                    u.push(C.rightSideBearing), s.push(x.advanceWidth);
                }
            }
            var S = {
                xMin: Math.min.apply(null, r),
            ...
            }), A = e.metas && Object.keys(e.metas).length > 0 ? Jt.make(e.metas) : void 0, q = [ R, O, D, L, _, G, H, X, F ];
        ...
        Ae.prototype = {
            ...
            getTable: function(e) {
                ...
                return !r && e && (r = this.font.tables[this.tableName] = this.createDefaultTable()), 
                r;
            },
            ...
            getFeatureTable: function(e, r, t, a) {
                ...
                if (n) {
                    for (var s, i = n.featureIndexes, u = this.font.tables[this.tableName].features, o = 0; o < i.length; o++) if (s = u[i[o]], 
                    s.tag === t) return s.feature;
                    if (a) {
                        var l = u.length;
                        return U.assert(l === 0 || t >= u[l - 1].tag, "Features must be added in alphabetical order."), 
                        s = {
                            tag: t,
                            feature: {
                                params: 0,
            ...
            getLookupTables: function(e, r, t, a, n) {
                ...
                if (s) {
                    for (var u, o = s.lookupListIndexes, l = this.font.tables[this.tableName].lookups, f = 0; f < o.length; f++) u = l[o[f]], 
                    u.lookupType === a && i.push(u);
                    if (i.length === 0 && n) {
                        u = {
                            lookupType: a,
                            lookupFlag: 0,
        ...
        K.prototype.addSingle = function(e, r, t, a) {
            ...
            u < 0 && (u = -1 - u, s.coverage.glyphs.splice(u, 0, i), s.substitute.splice(u, 0, 0)), 
            s.substitute[u] = r.by;
        };
        K.prototype.addMultiple = function(e, r, t, a) {
            ...
            var i = r.sub, u = this.binSearch(s.coverage.glyphs, i);
            u < 0 && (u = -1 - u, s.coverage.glyphs.splice(u, 0, i), s.sequences.splice(u, 0, 0)), 
            s.sequences[u] = r.by;
        };
        K.prototype.addAlternate = function(e, r, t, a) {
            ...
            var i = r.sub, u = this.binSearch(s.coverage.glyphs, i);
            u < 0 && (u = -1 - u, s.coverage.glyphs.splice(u, 0, i), s.alternateSets.splice(u, 0, 0)), 
        ...
        function $r(e, r, t, a, n) {
            var s;
            return (r & a) > 0 ? (s = e.parseByte(), (r & n) === 0 && (s = -s), s = t + s) : (r & n) > 0 ? s = t : s = t + e.parseShort(), 
            s;
        }
        function ea(e, r, t) {
            var a = new k.Parser(r, t);
            e.numberOfContours = a.parseShort(), e._xMin = a.parseShort(), e._yMin = a.parseShort(), 
            e._xMax = a.parseShort(), e._yMax = a.parseShort();
            var n, s;
            if (e.numberOfContours > 0) {
                ...
                n = [];
                for (var f = 0; f < l; f += 1) if (s = a.parseByte(), n.push(s), (s & 8) > 0) for (var h = a.parseByte(), p = 0; p < h; p += 1) n.push(s), 
                f += 1;
                if (U.argument(n.length === l, "Bad flags."), i.length > 0) {
                    var d, c = [];
                    if (l > 0) {
                        for (var x = 0; x < l; x += 1) s = n[x], d = {}, d.onCurve = !!(s & 1), d.lastPointOfContour = i.indexOf(x) >= 0, 
                        c.push(d);
                        for (var m = 0, y = 0; y < l; y += 1) s = n[y], d = c[y], d.x = $r(a, s, m, 2, 16), 
                        m = d.x;
                        for (var C = 0, S = 0; S < l; S += 1) s = n[S], d = c[S], d.y = $r(a, s, C, 4, 32), 
                        C = d.y;
                    }
                    e.points = c;
                } else e.points = [];
                ...
                for (var R = !0; R; ) {
                    ...
                    (n & 1) > 0 ? (n & 2) > 0 ? (O.dx = a.parseShort(), O.dy = a.parseShort()) : O.matchedPoints = [ a.parseUShort(), a.parseUShort() ] : (n & 2) > 0 ? (O.dx = a.parseChar(), 
                    O.dy = a.parseChar()) : O.matchedPoints = [ a.parseByte(), a.parseByte() ], (n & 8) > 0 ? O.xScale = O.yScale = a.parseF2Dot14() : (n & 64) > 0 ? (O.xScale = a.parseF2Dot14(), 
                    O.yScale = a.parseF2Dot14()) : (n & 128) > 0 && (O.xScale = a.parseF2Dot14(), O.scale01 = a.parseF2Dot14(), 
                    O.scale10 = a.parseF2Dot14(), O.yScale = a.parseF2Dot14()), e.components.push(O), 
                    R = !!(n & 32);
                }
                if (n & 256) {
                    e.instructionLength = a.parseUShort(), e.instructions = [];
        ...
        function Kn(e) {
            ...
            return U.argument(t.length === 0, "There are still points left in the current contour."), 
            r;
        }
        function ra(e) {
            var r = new P;
            ...
            for (var t = Kn(e), a = 0; a < t.length; ++a) {
                ...
                for (var l = 0; l < n.length; ++l) if (s = i, i = u, u = n[(l + 1) % n.length], 
                i.onCurve) r.lineTo(i.x, i.y); else {
                    var h = u;
                    s.onCurve || {
                        x: (i.x + s.x) * .5,
                        y: (i.y + s.y) * .5
        ...
        var ua = function(e) {
            ...
            return e < 0 && (e = -e, n = -1), e += a - t, e = Math.trunc(e / r) * r, e += t, 
            e < 0 ? t * n : e * n;
        }, oe = {
            x: 1,
            y: 0,
            ...
            interpolate: function(e, r, t, a) {
                var n, s, i, u, o, l, f;
                if (!a || a === this) {
                    if (n = e.xo - r.xo, s = e.xo - t.xo, o = r.x - r.xo, l = t.x - t.xo, i = Math.abs(n), 
                    u = Math.abs(s), f = i + u, f === 0) {
                        e.x = e.xo + (o + l) / 2;
                        return;
                    }
                    e.x = e.xo + (o * u + l * i) / f;
                ...
                if (n = a.distance(e, r, !0, !0), s = a.distance(e, t, !0, !0), o = a.distance(r, r, !1, !0), 
                l = a.distance(t, t, !1, !0), i = Math.abs(n), u = Math.abs(s), f = i + u, f === 0) {
            ...
            interpolate: function(e, r, t, a) {
                var n, s, i, u, o, l, f;
                if (!a || a === this) {
                    if (n = e.yo - r.yo, s = e.yo - t.yo, o = r.y - r.yo, l = t.y - t.yo, i = Math.abs(n), 
                    u = Math.abs(s), f = i + u, f === 0) {
                        e.y = e.yo + (o + l) / 2;
                        return;
                    }
        ...
        Object.freeze(le);
        function Ie(e, r) {
            this.x = e, this.y = r, this.axis = void 0, this.slope = r / e, this.normalSlope = -e / r, 
            Object.freeze(this);
        }
        ...
        Ie.prototype.interpolate = function(e, r, t, a) {
            var n, s, i, u, o, l, f;
            if (i = a.distance(e, r, !0, !0), u = a.distance(e, t, !0, !0), n = a.distance(r, r, !1, !0), 
            s = a.distance(t, t, !1, !0), o = Math.abs(i), l = Math.abs(u), f = o + l, f === 0) {
        ...
        function fe(e, r, t, a) {
            this.x = this.xo = Math.round(e * 64) / 64, this.y = this.yo = Math.round(r * 64) / 64, 
            this.lastPointOfContour = t, this.onCurve = a, this.prevPointOnContour = void 0, 
        ...
        ia.prototype.exec = function(e, r) {
            ...
            if (!(this._errorState > 2)) {
                ...
                if (!a || a.ppem !== r) {
                    ...
                    if (!n) {
                        de.prototype = ss, n = this._fpgmState = new de("fpgm", t.tables.fpgm), n.funcs = [], 
                        n.font = t, exports.DEBUG && (console.log("---EXEC FPGM---"), n.step = -1);
                        try {
                            Se(n);
                        } catch (l) {
                ...
                if (!(this._errorState > 1)) try {
                    ...
                    this._errorState < 1 && (console.log("Hinting error:" + l), console.log("Note: further hinting errors are silenced")), 
                    this._errorState = 1;
                    return;
                }
            }
        ...
        sa = function(e, r) {
            var s, i, u, t = r.ppem / r.font.unitsPerEm, a = t, n = e.components;
            if (de.prototype = r, !n) u = new de("glyf", e.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), 
            u.step = -1), br(e, u, t, a), i = u.gZone; else {
                var o = r.font;
                i = [], s = [];
                for (var l = 0; l < n.length; l++) {
                    var f = n[l], h = o.glyphs.get(f.glyphIndex);
                    u = new de("glyf", h.instructions), exports.DEBUG && (console.log("---EXEC COMP " + l + "---"), 
                    u.step = -1), br(h, u, t, a);
                ...
                e.instructions && !u.inhibitGridFit && (u = new de("glyf", e.instructions), u.gZone = u.z0 = u.z1 = u.z2 = i, 
                u.contours = s, i.push(new fe(0, 0), new fe(Math.round(e.advanceWidth * t), 0)), 
                exports.DEBUG && (console.log("---EXEC COMPOSITE---"), u.step = -1), Se(u), i.length -= 2);
            }
            return i;
        };
        br = function(e, r, t, a) {
            for (var o, n = e.points || [], s = n.length, i = r.gZone = r.z0 = r.z1 = r.z2 = [], u = r.contours = [], l = 0; l < s; l++) o = n[l], 
            i[l] = new fe(o.x * t, o.y * a, o.lastPointOfContour, o.onCurve);
            for (var f, h, p = 0; p < s; p++) o = i[p], f || (f = o, u.push(p)), o.lastPointOfContour ? (o.nextPointOnContour = f, 
            f.prevPointOnContour = o, f = void 0) : (h = i[p + 1], o.nextPointOnContour = h, 
            ...
            if (!r.inhibitGridFit) {
                ...
                if (i.push(new fe(0, 0), new fe(Math.round(e.advanceWidth * t), 0)), Se(r), i.length -= 2, 
                exports.DEBUG) {
        ...
        function ys(e) {
            var r = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "SZPS[]", r), e.zp0 = e.zp1 = e.zp2 = r, 
            r) {
              case 0:
        ...
        function it(e, r) {
            var n, s, i, t = r.z2, a = t.length - 2;
            exports.DEBUG && console.log(r.step, "IUP[" + e.axis + "]");
            for (var u = 0; u < a; u++) n = t[u], !e.touched(n) && (s = n.prevTouched(e), s !== n && (i = n.nextTouched(e), 
            s === i && e.setRelative(n, n, e.distance(s, s, !1, !0), e, !0), e.interpolate(n, s, i, e)));
        }
        function ot(e, r) {
        ...
        function lt(e, r) {
            ...
            for (var l, f = i.distance(n, n, !1, !0), h = o.length - 2, p = 0; p < h; p++) l = o[p], 
            s.setRelative(l, l, f, i);
        }
        function Is(e) {
            for (var r = e.stack, t = e.loop, a = e.fv, n = r.pop() / 64, s = e.z2; t--; ) {
                var i = r.pop(), u = s[i];
                exports.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - t) + ": " : "") + "SHPIX[]", i, n), 
        ...
        function Ms(e) {
            for (var r = e.stack, t = e.rp1, a = e.rp2, n = e.loop, s = e.z0[t], i = e.z1[a], u = e.fv, o = e.dpv, l = e.z2; n--; ) {
                var f = r.pop(), h = l[f];
                exports.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - n) + ": " : "") + "IP[]", f, t, "<->", a), 
        ...
        function ft(e, r) {
            ...
            u.setRelative(s, i, a, o), u.touch(s), exports.DEBUG && console.log(r.step, "MSIRP[" + e + "]", a, n), 
            r.rp1 = r.rp0, r.rp2 = n, e && (r.rp0 = n);
        }
        function Ps(e) {
            for (var r = e.stack, t = e.rp0, a = e.z0[t], n = e.loop, s = e.fv, i = e.pv, u = e.z1; n--; ) {
                var o = r.pop(), l = u[o];
                exports.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - n) + ": " : "") + "ALIGNRP[]", o), 
        ...
        function pt(e, r) {
            ...
            e && (Math.abs(l - o) < r.cvCutIn && (l = o), l = r.round(l)), i.setRelative(s, De, l, u), 
            r.zp0 === 0 && (s.xo = s.x, s.yo = s.y), i.touch(s), r.rp0 = r.rp1 = n;
        }
        function Ns(e) {
        ...
        function ki(e) {
            ...
            exports.DEBUG && console.log(e.step, "GETINFO[]", t), t & 1 && (a = 35), t & 32 && (a |= 4096), 
            r.push(a);
        }
        function Fi(e) {
        ...
        function T(e, r, t, a, n, s) {
            var x, m, y, C, i = s.stack, u = e && i.pop(), o = i.pop(), l = s.rp0, f = s.z0[l], h = s.z1[o], p = s.minDis, c = s.fv, d = s.dpv;
            m = x = d.distance(h, f, !0, !0), y = m >= 0 ? 1 : -1, m = Math.abs(m), e && (C = s.cvt[u], 
            a && Math.abs(m - C) < s.cvCutIn && (m = C)), t && m < p && (m = p), a && (m = s.round(m)), 
            c.setRelative(h, f, y * m, d), c.touch(h), exports.DEBUG && console.log(s.step, (e ? "MIRP[" : "MDRP[") + (r ? "M" : "m") + (t ? ">" : "_") + (a ? "R" : "_") + (n === 0 ? "Gr" : n === 1 ? "Bl" : n === 2 ? "Wh" : "") + "]", e ? u + "(" + s.cvt[u] + "," + C + ")" : "", o, "(d =", x, "->", y * m, ")"), 
        ...
        function Li(e, r, t) {
            this.contextName = e, this.openRange = null, this.ranges = [], this.checkStart = r, 
            this.checkEnd = t;
        }
        function re(e, r) {
            this.context = e, this.index = r, this.length = e.length, this.current = e[r], this.backtrack = e.slice(0, r), 
        ...
        function B(e) {
            this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, 
            this.registeredModifiers = [], Ri.call(this, e);
        }
        ...
        B.prototype.insertToken = function(e, r, t) {
            ...
            return a ? (this.tokens.splice.apply(this.tokens, [ r, 0 ].concat(e)), t || this.dispatch("insertToken", [ e, r ]), 
            e) : {
        ...
        re.prototype.setCurrentIndex = function(e) {
            this.index = e, this.current = this.context[e], this.backtrack = this.context.slice(0, e), 
        ...
        B.prototype.setEndOffset = function(e, r) {
            ...
            return a.rangeId = r + "." + n.length, n.push(a), this.getContext(r).openRange = null, 
            a;
        };
        B.prototype.runContextCheck = function(e) {
            ...
            this.contextCheckers.forEach((function(a) {
                ...
                if (!s && a.checkStart(e) && (s = new Lr(t, null, n), r.getContext(n).openRange = s, 
                r.dispatch("contextStart", [ n, t ])), !!s && a.checkEnd(e)) {
        ...
        function Xi(e, r, t) {
            ...
            for (var n = e.substitution.components.length, s = 0; s < n; s++) a = r[t + s + 1], 
            a.setState("deleted", !0);
        }
        var dt = {
            11: _i,
            12: Vi,
        ...
        function ro() {
            return pr.call(this, "latinWord"), pr.call(this, "arabicWord"), pr.call(this, "arabicSentence"), 
        ...
        ne.prototype.applyFeaturesToContexts = function() {
            this.checkContextReady("arabicWord") && (ao.call(this), no.call(this)), this.checkContextReady("latinWord") && so.call(this), 
        ...
        function w(e) {
            e = e || {}, e.tables = e.tables || {}, e.empty || (Ee(e.familyName, "When creating a new Font object, familyName is required."), 
            Ee(e.styleName, "When creating a new Font object, styleName is required."), Ee(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), 
            Ee(e.ascender, "When creating a new Font object, ascender is required."), Ee(e.descender <= 0, "When creating a new Font object, negative descender value is required."), 
            this.names = {
                fontFamily: {
                    en: e.familyName || " "
                },
            ...
            this.createdTimestamp = e.createdTimestamp, this.tables = Object.assign(e.tables, {
                os2: Object.assign({
            ...
            })), this.supported = !0, this.glyphs = new ue.GlyphSet(this, e.glyphs || []), this.encoding = new Ot(this), 
            this.position = new Be(this), this.substitution = new K(this), this.tables = this.tables || {}, 
            this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
                get: function() {
        ...
        w.prototype.forEachGlyph = function(e, r, t, a, n, s) {
            ...
            var o, i = 1 / this.unitsPerEm * a, u = this.stringToGlyphs(e, n);
            if (n.kerning) {
        ...
        w.prototype.download = function(e) {
            ...
            if (Zn()) if (window.URL = window.URL || window.webkitURL, window.URL) {
                var n = new DataView(a), s = new Blob([ n ], {
                    type: "font/opentype"
        ...
        function oo(e, r, t) {
            ...
            return a.tag = n.parseTag(), a.minValue = n.parseFixed(), a.defaultValue = n.parseFixed(), 
            a.maxValue = n.parseFixed(), n.skip("uShort", 1), a.name = t[n.parseUShort()] || {}, 
            a;
        }
        function uo(e, r, t, a) {
        ...
        var ho = {
            ...
            if (U.argument(e === 1 || e === 2 || e === 3, "Unsupported CaretValue table version."), 
            e === 1) return {
        ...
        function So(e, r) {
            r = r || 0;
            var t = new v(e, r), a = t.parseVersion(1);
            return U.argument(a === 1 || a === 1.1, "Unsupported GPOS table version " + a), 
            a === 1 ? {
                version: a,
                scripts: t.parseScriptList(),
                features: t.parseFeatureList(),
        ...
        function Dr(e, r) {
            ...
            var t, a, i, n = new w({
                empty: !0
            }), s = new DataView(e, 0), u = [], o = k.getTag(s, 0);
            if (o === String.fromCharCode(0, 1, 0, 0) || o === "true" || o === "typ1") n.outlinesFormat = "truetype", 
            i = k.getUShort(s, 4), u = yt(s, i); else if (o === "OTTO") n.outlinesFormat = "cff", 
            i = k.getUShort(s, 4), u = yt(s, i); else if (o === "wOFF") {
                var l = k.getTag(s, 4);
            ...
            for (var f, h, p, c, d, x, m, y, C, S, R, O, D = 0; D < i; D += 1) {
                ...
                switch (L.tag) {
                  ...
                  case "head":
                    F = I(s, L), n.tables.head = Nt.parse(F.data, F.offset), n.unitsPerEm = n.tables.head.unitsPerEm, 
                    t = n.tables.head.indexToLocFormat;
                    break;

                  case "hhea":
                    F = I(s, L), n.tables.hhea = Ht.parse(F.data, F.offset), n.ascender = n.tables.hhea.ascender, 
                    n.descender = n.tables.hhea.descender, n.numberOfHMetrics = n.tables.hhea.numberOfHMetrics;
                    break;
            ...
            var N = I(s, m);
            if (zt.parse(n, N.data, N.offset, n.numberOfHMetrics, n.numGlyphs, n.glyphs, r), 
            _a(n, r), y) {
                var W = I(s, y);
